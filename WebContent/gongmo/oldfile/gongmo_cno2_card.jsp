			...
			<div class="col-md-8">
				<c:forEach var="vo" items="${list }">
					<div class="col-md-4 col-md-8">
						<div class="thumbnail">
							<a
								href="../gongmo/gongmo_detail.do?no=${vo.gm_no }&page=${curpage}&gm_cate=2">
			...
			<div class="text-center">
				<ul class="pagination">
					<c:if test="${curpage>BLOCK }">
						<li><a href="../gongmo/gongmo_cno2.do?page=${startPage-1 }">&lt;</a></li>
					</c:if>
					<c:forEach var="i" begin="${startPage }" end="${endPage }">
						<c:if test="${i==curpage }">
							<li class="active"><a
								href="../gongmo/gongmo_cno2.do?page=${i }">${i }</a></li>
						</c:if>
						<c:if test="${i!=curpage }">
							<li><a href="../gongmo/gongmo_cno2.do?page=${i }">${i }</a></li>
						</c:if>
					</c:forEach>
					<c:if test="${endPage<totalpage }">
						<li><a href="../gongmo/gongmo_cno2.do?page=${endPage+1 }">&gt;</a></li>
					</c:if>
				</ul>
			</div>
		</div>
